...
Deno.writeTextFileSync('src/github-patcher.css', hideCssContent);
...
console.log('Generated src/github-patcher.css and src/css-constants.ts from src/github-patcher-show.css');